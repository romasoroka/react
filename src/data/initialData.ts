...
import { Project, ProjectStatus, Credential, Employee } from '../types';
...
export const initialProjects: Project[] = [
  {
    ...
    detailedDescription: 'Повноцінна CRM з інтеграцією e-mail, календаря та звітністю.',
  ...
  },
  {
    ...
    detailedDescription: 'Інтеграція з системами бронювання, онлайн-оплата, карта готелів.',
