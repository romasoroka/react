  ...
  return (
    <div className="flex flex-col animate-slideIn">
      <div className="p-2 rounded-lg bg-white/50 hover:bg-gray-100/80 dark:bg-gray-800 dark:hover:bg-gray-700/80 transition-colors">
        ...
        >
          {project.status === 0 ? 'Active' : project.status === 1 ? 'Completed' : project.status === 2 ? 'OnHold' : 'Cancelled'}
        </span>
      </div>
      <div className="p-2 rounded-lg bg-white/50 hover:bg-gray-100/80 dark:bg-gray-800 dark:hover:bg-gray-700/80 transition-colors">
        <span className="text-sm font-semibold text-gray-800 dark:text-gray-100">Опис:</span>
        <p className="text-sm text-gray-600 dark:text-gray-300 mt-2 leading-relaxed">{project.description}</p>
      </div>
      <div className="p-2 rounded-lg bg-white/50 hover:bg-gray-100/80 dark:bg-gray-800 dark:hover:bg-gray-700/80 transition-colors">
      ...
      <div className="p-2 rounded-lg bg-white/50 hover:bg-gray-100/80 dark:bg-gray-800 dark:hover:bg-gray-700/80 transition-colors">
        ...
        <span className="text-sm text-gray-600 dark:text-gray-300 ml-2">{formatDate(project.startDate)}</span>
      </div>
      <div className="p-2 rounded-lg bg-white/50 hover:bg-gray-100/80 dark:bg-gray-800 dark:hover:bg-gray-700/80 transition-colors">
        <span className="text-sm font-semibold text-gray-800 dark:text-gray-100">Дата завершення:</span>
        <span className="text-sm text-gray-600 dark:text-gray-300 ml-2">{project.endDate ? formatDate(project.endDate) : 'Не вказано'}</span>
      </div>
      <div className="p-2 rounded-lg bg-white/50 hover:bg-gray-100/80 dark:bg-gray-800 dark:hover:bg-gray-700/80 transition-colors">
        <span className="text-sm font-semibold text-gray-800 dark:text-gray-100">Бюджет:</span>
        <span className="text-sm text-gray-600 dark:text-gray-300 ml-2">{project.budget || 'Не вказано'}</span>
      </div>
      <div className="p-2 rounded-lg bg-white/50 hover:bg-gray-100/80 dark:bg-gray-800 dark:hover:bg-gray-700/80 transition-colors">
        <span className="text-sm font-semibold text-gray-800 dark:text-gray-100">Клієнт:</span>
        <span className="text-sm text-gray-600 dark:text-gray-300 ml-2">{project.client || 'Не вказано'}</span>
      </div>
    </div>
  );
};
